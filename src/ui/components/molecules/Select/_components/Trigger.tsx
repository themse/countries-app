...
const triggerVariants = tv({
	slots: {
		wrapper:
			'flex w-full items-center justify-between rounded-md px-4 py-5 text-sm font-medium shadow-md shadow-black/30 focus:outline-none focus:ring-2 focus:ring-gray-900/20 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-gray-700 [&>span]:line-clamp-1',
		icon: 'h-5 w-5',
	},
});
